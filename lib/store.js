...
// e.g. the Upstash integration — Vercel's old first-party "KV" product was
// retired and replaced by this).
//
...
// Different Redis marketplace integrations name their env vars slightly
// differently (KV_REST_API_* is the legacy/compat naming some providers
// still use, UPSTASH_REDIS_REST_* is Upstash's own naming) — accept either
// so this works regardless of which one shows up in your project settings.
const kv = new Redis({
